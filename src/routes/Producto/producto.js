...
import {
  createReferenceProductC3TypeA,
  createInspectionProductC3TypeA,
  createReferenceProductC3TypeV,
  createInspectionProductC3TypeV,
  getAllProductsC3,
  getPracticeThreeProductInfoPerGroup,
  getPracticeThreeProductAtributesPerGroup,
  getPracticeThreeProductPerStudent,
  getPracticeThreeProductInfoPerStudent,
  getPracticeThreeProductAtributes,
...
// router.get(
//   "/corte1/inspeccion/estudiante/:idEstudiante",
//   getPracticeOneProductPerStudent
// );
...
// Conocer la informacion de un producto de acuerdo al grupo al que fue asignado:
router.get(
  "/corte2/:idPractica/:nombreGrupo",
  getPracticeTwoProductInfoPerGroup
);
// Conocer los atributos asignados al producto de un grupo especifico:
router.get(
  "/corte2/atributos/grupo/:nombreGrupo/:idPractica",
  getPracticeTwoProductAtributesPerGroup
);
...
router.get(
  "/corte2/inspeccion/:idPractica/:idEstudiante/:nombreSubgrupo",
  getProductInfoPerSubgroupAndStudent
);
// Consultar los atributos de un determinado producto especifico:
router.get(
  "/corte2/atributos/inspeccion/:idProductoC2",
  getPracticeTwoProductAtributes
);
...
// Conocer la informacion de un producto de acuerdo al grupo al que fue asignado:
router.get(
  "/corte3/:idPractica/:nombreGrupo",
  getPracticeThreeProductInfoPerGroup
);
// Conocer los atributos asignados al producto de un grupo especifico:
router.get(
  "/corte3/atributos/grupo/:nombreGrupo/:idPractica",
  getPracticeThreeProductAtributesPerGroup
);
// Conocer los productos que tuvo/tiene que inspeccionar un estudiante especifico:
router.get(
  "/corte3/inspeccion/estudiante/:idEstudiante",
  getPracticeThreeProductPerStudent
);
// Consultar toda la informacion de los productos asignados a un estudiante especifico (incluyendo atributos)
router.get(
  "/corte3/inspeccion/atributos/estudiante/:idEstudiante",
  getPracticeThreeProductInfoPerStudent
);
// Consultar los atributos de un determinado producto especifico:
router.get(
  "/corte3/atributos/inspeccion/:idProductoC3",
  getPracticeThreeProductAtributes
);
